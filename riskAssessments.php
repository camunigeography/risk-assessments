...
class riskAssessments extends reviewableAssessments
{
	...
	public function databaseStructureSpecificFields ()
	{
		...
		return $sql = "
			  ...
			  `contactName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Name of a personal contact',
			  ...
			  `organicMaterial` enum('Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Soil and/or plant material',
			  `fcoWebsiteChecked` enum('Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'FCO website',
			  `fcoAdviseAgainst` enum('No','Yes') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'FCO advice',
			  `insurance` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Insurance',
			  `stayingAddress` text COLLATE utf8mb4_unicode_ci COMMENT 'Local address',
			  `stayingPhone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Local phone',
			  `stayingMobile` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Local mobile',
			  `travellingWith` text COLLATE utf8mb4_unicode_ci COMMENT 'Travelling with',
			  `advicePerson` text COLLATE utf8mb4_unicode_ci COMMENT 'Taken advice',
			  `hazard1_description` text COLLATE utf8mb4_unicode_ci,
			  `hazard1_risks` text COLLATE utf8mb4_unicode_ci,
			  `hazard1_likelihood` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `hazard1_reduction` text COLLATE utf8mb4_unicode_ci,
			  `hazard1_person` text COLLATE utf8mb4_unicode_ci,
			  `hazard2_description` text COLLATE utf8mb4_unicode_ci,
			  `hazard2_risks` text COLLATE utf8mb4_unicode_ci,
			  `hazard2_likelihood` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `hazard2_reduction` text COLLATE utf8mb4_unicode_ci,
			  `hazard2_person` text COLLATE utf8mb4_unicode_ci,
			  `hazard3_description` text COLLATE utf8mb4_unicode_ci,
			  `hazard3_risks` text COLLATE utf8mb4_unicode_ci,
			  `hazard3_likelihood` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `hazard3_reduction` text COLLATE utf8mb4_unicode_ci,
			  `hazard3_person` text COLLATE utf8mb4_unicode_ci,
			  `hazard4_description` text COLLATE utf8mb4_unicode_ci,
			  `hazard4_risks` text COLLATE utf8mb4_unicode_ci,
			  `hazard4_likelihood` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `hazard4_reduction` text COLLATE utf8mb4_unicode_ci,
			  `hazard4_person` text COLLATE utf8mb4_unicode_ci,
			  `hazard5_description` text COLLATE utf8mb4_unicode_ci,
			  `hazard5_risks` text COLLATE utf8mb4_unicode_ci,
			  `hazard5_likelihood` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `hazard5_reduction` text COLLATE utf8mb4_unicode_ci,
			  `hazard5_person` text COLLATE utf8mb4_unicode_ci,
			  `hazard6_description` text COLLATE utf8mb4_unicode_ci,
			  `hazard6_risks` text COLLATE utf8mb4_unicode_ci,
			  `hazard6_likelihood` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `hazard6_reduction` text COLLATE utf8mb4_unicode_ci,
			  `hazard6_person` text COLLATE utf8mb4_unicode_ci,
			  `hazard7_description` text COLLATE utf8mb4_unicode_ci,
			  `hazard7_risks` text COLLATE utf8mb4_unicode_ci,
			  `hazard7_likelihood` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `hazard7_reduction` text COLLATE utf8mb4_unicode_ci,
			  `hazard7_person` text COLLATE utf8mb4_unicode_ci,
			  `hazard8_description` text COLLATE utf8mb4_unicode_ci,
			  `hazard8_risks` text COLLATE utf8mb4_unicode_ci,
			  `hazard8_likelihood` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `hazard8_reduction` text COLLATE utf8mb4_unicode_ci,
			  `hazard8_person` text COLLATE utf8mb4_unicode_ci,
			  `hazard9_description` text COLLATE utf8mb4_unicode_ci,
			  `hazard9_risks` text COLLATE utf8mb4_unicode_ci,
			  `hazard9_likelihood` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `hazard9_reduction` text COLLATE utf8mb4_unicode_ci,
			  `hazard9_person` text COLLATE utf8mb4_unicode_ci,
			  `hazard10_description` text COLLATE utf8mb4_unicode_ci,
			  `hazard10_risks` text COLLATE utf8mb4_unicode_ci,
			  `hazard10_likelihood` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `hazard10_reduction` text COLLATE utf8mb4_unicode_ci,
			  `hazard10_person` text COLLATE utf8mb4_unicode_ci,
			  `equipment1_name` text COLLATE utf8mb4_unicode_ci,
			  `equipment1_value` int(11) DEFAULT NULL,
			  `equipment1_transportation` text COLLATE utf8mb4_unicode_ci,
			  `equipment1_insurance` enum('','Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment1_risk` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment1_security` text COLLATE utf8mb4_unicode_ci,
			  `equipment2_name` text COLLATE utf8mb4_unicode_ci,
			  `equipment2_value` int(11) DEFAULT NULL,
			  `equipment2_transportation` text COLLATE utf8mb4_unicode_ci,
			  `equipment2_insurance` enum('','Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment2_risk` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment2_security` text COLLATE utf8mb4_unicode_ci,
			  `equipment3_name` text COLLATE utf8mb4_unicode_ci,
			  `equipment3_value` int(11) DEFAULT NULL,
			  `equipment3_transportation` text COLLATE utf8mb4_unicode_ci,
			  `equipment3_insurance` enum('','Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment3_risk` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment3_security` text COLLATE utf8mb4_unicode_ci,
			  `equipment4_name` text COLLATE utf8mb4_unicode_ci,
			  `equipment4_value` int(11) DEFAULT NULL,
			  `equipment4_transportation` text COLLATE utf8mb4_unicode_ci,
			  `equipment4_insurance` enum('','Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment4_risk` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment4_security` text COLLATE utf8mb4_unicode_ci,
			  `equipment5_name` text COLLATE utf8mb4_unicode_ci,
			  `equipment5_value` int(11) DEFAULT NULL,
			  `equipment5_transportation` text COLLATE utf8mb4_unicode_ci,
			  `equipment5_insurance` enum('','Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment5_risk` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment5_security` text COLLATE utf8mb4_unicode_ci,
			  `equipment6_name` text COLLATE utf8mb4_unicode_ci,
			  `equipment6_value` int(11) DEFAULT NULL,
			  `equipment6_transportation` text COLLATE utf8mb4_unicode_ci,
			  `equipment6_insurance` enum('','Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment6_risk` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment6_security` text COLLATE utf8mb4_unicode_ci,
			  `equipment7_name` text COLLATE utf8mb4_unicode_ci,
			  `equipment7_value` int(11) DEFAULT NULL,
			  `equipment7_transportation` text COLLATE utf8mb4_unicode_ci,
			  `equipment7_insurance` enum('','Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment7_risk` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment7_security` text COLLATE utf8mb4_unicode_ci,
			  `equipment8_name` text COLLATE utf8mb4_unicode_ci,
			  `equipment8_value` int(11) DEFAULT NULL,
			  `equipment8_transportation` text COLLATE utf8mb4_unicode_ci,
			  `equipment8_insurance` enum('','Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment8_risk` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment8_security` text COLLATE utf8mb4_unicode_ci,
			  `equipment9_name` text COLLATE utf8mb4_unicode_ci,
			  `equipment9_value` int(11) DEFAULT NULL,
			  `equipment9_transportation` text COLLATE utf8mb4_unicode_ci,
			  `equipment9_insurance` enum('','Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment9_risk` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment9_security` text COLLATE utf8mb4_unicode_ci,
			  `equipment10_name` text COLLATE utf8mb4_unicode_ci,
			  `equipment10_value` int(11) DEFAULT NULL,
			  `equipment10_transportation` text COLLATE utf8mb4_unicode_ci,
			  `equipment10_insurance` enum('','Yes','No') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment10_risk` enum('','Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `equipment10_security` text COLLATE utf8mb4_unicode_ci,
			  `seniorPersonSignature` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
			  `seniorPersonDate` datetime DEFAULT NULL,
			  `customsCountry1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Customs - Country (1)',
			  `customsDocument1` text COLLATE utf8mb4_unicode_ci COMMENT 'Customs - document details (1)',
			  `customsCountry2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Customs - Country (2)',
			  `customsDocument2` text COLLATE utf8mb4_unicode_ci COMMENT 'Customs - document details (2)',
			  `customsCountry3` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Customs - Country (3)',
			  `customsDocument3` text COLLATE utf8mb4_unicode_ci COMMENT 'Customs - document details (3)',
			  `healthInsuranceProvider` text COLLATE utf8mb4_unicode_ci COMMENT 'Health insurance provider',
			  `healthInsurancePolicy` text COLLATE utf8mb4_unicode_ci COMMENT 'Health insurance policy number',
			  `travelInsuranceProvider` text COLLATE utf8mb4_unicode_ci COMMENT 'Travel insurance provider',
			  `travelInsurancePolicy` text COLLATE utf8mb4_unicode_ci COMMENT 'Travel insurance policy number',
			  `equipmentInsuranceProvider` text COLLATE utf8mb4_unicode_ci COMMENT 'Equipment insurance provider',
			  `equipmentInsurancePolicy` text COLLATE utf8mb4_unicode_ci COMMENT 'Equipment insurance policy number',
		";
	}
