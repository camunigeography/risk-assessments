...
class riskAssessments_form_default
{
	...
	public function form_default_dataBindingAttributes ($dataBindingAttributes, $data)
	{
		...
		$dataBindingAttributes += array (
			...
			'customsCountry1'				=> array ('type' => 'select', 'values' => $this->countries, 'required' => $stage2InfoRequired, ),
			'customsDocument1'				=> array ('rows' => 4, 'cols' => 50, 'required' => $stage2InfoRequired, ),
			'customsCountry2'				=> array ('type' => 'select', 'values' => $this->countries, ),
			'customsDocument2'				=> array ('rows' => 4, 'cols' => 50, ),
			'customsCountry3'				=> array ('type' => 'select', 'values' => $this->countries, ),
